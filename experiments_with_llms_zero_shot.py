# -*- coding: utf-8 -*-
"""Experiments with LLMs-Zero Shot.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1n98nlzbOWlGfmS1uazGyAho3i6NsMpQB
"""
...
df=pd.read_csv('math_ODEsdataset_zeropythoncsv.txt') # Please update this path if your file is in a different location
df.head(60)
...
CACHE_FILE = Path('math_ODEsdataset_zeropythoncsv.txt_ler')
...
# Carrega o dataset
df = pd.read_csv('math_ODEsdataset_zeropythoncsv.txt')
...
# Salva o CSV final
df.to_csv('math_ODEsdataset_zeropythoncsv.txt_models', index=False)
...
model["Question"].iloc[51]

model["Proposed Solution"].iloc[51]

model["anthropic/claude-haiku-4.5_class"].iloc[51]

model["anthropic/claude-haiku-4.5_class_result"].iloc[51]

model["google/gemma-2-27b-it_class"].iloc[51]

model["google/gemma-2-27b-it_class_result"].iloc[51]
